...
- Validar v2.5.0 en Android con visitas y datos reales de campo.
...
- Mejorar dashboard por tenencia/hacienda si se solicita.
- Preparar sincronización central (p. ej. Supabase/PostgreSQL) solo con autorización.
- Evaluar edición de biometrías guardadas con auditoría completa.
